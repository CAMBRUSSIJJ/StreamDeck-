...
const required = ['index.html','styles.css','manifest.webmanifest','sw.js','js/app.js','js/ui/icons.js','js/core/editor.js','js/core/widgets.js','js/core/crypto.js','js/core/realtime.js','js/core/protocol.js','js/core/store.js'];
...
if (!sw.includes('nexus-deck-v0.5.0')) throw new Error('cache do SW sem versão');

...
A V1.5 usa uma única instância do Companion. Um segundo lançamento detecta o painel em `127.0.0.1:38473`, abre a instância existente e encerra o novo processo.
...
O Companion consulta a release mais recente de `CAMBRUSSIJJ/StreamDeck` pelo GitHub Releases apenas quando o usuário solicita. A V1.5 informa se há versão nova e abre a release; não substitui o executável silenciosamente.

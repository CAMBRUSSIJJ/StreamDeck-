# Deploy, instalação e uso — Nexus Deck v1.0

## Windows — caminho recomendado

1. Execute `NexusDeck-Setup-v1.0.0.exe`.
...
Em Ajustes, use **Exportar deck** e **Importar deck**. A V1.0 usa Backup V2 com verificação de integridade e preview da quantidade de páginas, controles, macros e perfis. Dispositivos pareados permanecem no iPad e não são substituídos.

...
1. Execute `NexusDeck-Setup-v1.5.0.exe`.
...
Em Ajustes, use **Exportar deck** e **Importar deck**. A V1.5 usa Backup V2 com verificação de integridade e preview da quantidade de páginas, controles, macros e perfis. Dispositivos pareados permanecem no iPad e não são substituídos.

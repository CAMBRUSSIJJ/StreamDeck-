export const CONTROL_KINDS = new Set(['button','toggle','macro','volume','media_panel','status','clock']);
...
const presets = {
  ...
  macro: { label:'Nova macro', icon:'⚡', color:'#9b7cff', size:'wide', action:{type:'macro', stopOnError:true, steps:[{id:'step-1', when:'always', delayMs:0, action:{type:'open_url', url:'https://'}}]} },
